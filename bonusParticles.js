...
export default class BonusParticles {
  constructor() {
    ...
    for (var i = 0; i < 10; i++) {
        ...
        var partGreen = new THREE.Mesh(smallParticleGeom, Material.PhongGreen);
  ...
  explode () {
    ...
    for (var i = 0; i < this.parts.length; i++) {
        ...
        TweenMax.to(p.scale, s, { x: .01, y: .01, z: .01, ease: Power4.easeOut, onComplete: this.removeParticle, onCompleteParams: [p] });
    }
  }
